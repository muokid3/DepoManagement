                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="active"><a href="#adduser" data-toggle="tab">Products > {{$product->product_name}}</a></li>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="adduser">
                                    <b>Edit Product</b>
                                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/products/update') }}">
                                        {{ csrf_field() }}
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="col-md-12 {{ $errors->has('name') ? ' has-error' : '' }}" style="margin-bottom: 0px">
                                                            ...
                                                            <span class="input-group-addon">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" value="{{$product->product_name}}" name="name" autofocus required >
                                                                    {{$errors->first("name") }}
                                                                </div>
                                                            </div>
                                                        </div>
