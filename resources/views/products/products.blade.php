                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Products
                                <small>Add, remove, edit products of the system</small>
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                ...
                                <li role="presentation"><a href="#adduser" data-toggle="tab">ADD PRODUCTS</a></li>
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="col-md-12 {{ $errors->has('name') ? ' has-error' : '' }}" style="margin-bottom: 0px">
                                                            ...
                                                            <span class="input-group-addon">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" name="name" autofocus required placeholder="Product Name">
                                                                    {{$errors->first("name") }}
                                                                </div>
                                                            </div>
                                                        </div>
