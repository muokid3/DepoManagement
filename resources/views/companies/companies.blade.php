                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Companies
                                <small>Add, remove, edit companies</small>
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="active"><a href="#home" data-toggle="tab">COMPANIES</a></li>
                                <li role="presentation"><a href="#adduser" data-toggle="tab">ADD COMPANY</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="adduser">
                                    <b>Add Company</b>
                                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/companies/new') }}">
                                        {{ csrf_field() }}
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="col-md-12 {{ $errors->has('company_name') ? ' has-error' : '' }}" style="margin-bottom: 0px">
                                                            ...
                                                            <span class="input-group-addon">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" name="company_name" autofocus required placeholder="Company Name">
