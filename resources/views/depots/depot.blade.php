            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Product Management - Depot
                                <small>View / edit a depot</small>
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs tab-nav-right" role="tablist">
                                <li role="presentation" class="active"><a href="#adduser" data-toggle="tab">Depots > {{$depot->depot_name}}</a></li>
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="adduser">
                                    <b>Edit Product</b>
                                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/depots/update') }}">
                                        {{ csrf_field() }}
                                                    ...
                                                    <div class="row clearfix">
                                                        <div class="col-md-12 {{ $errors->has('depot_name') ? ' has-error' : '' }}" style="margin-bottom: 0px">
                                                            ...
                                                            <span class="input-group-addon">
                                                                ...
                                                                <div class="form-line">
                                                                    <input type="text" class="form-control" value="{{$depot->depot_name}}" name="depot_name" autofocus required >
